...
class TeamChatEndpoints extends WebEndpoints {
    chatChannelMentionGroup = {
        listChannelMentionGroups: this.buildEndpoint({ method: "GET", urlPathBuilder: ({ channelId }) => `/chat/channels/${channelId}/mention_group` }),
        createChannelMentionGroup: this.buildEndpoint({ method: "POST", urlPathBuilder: ({ channelId }) => `/chat/channels/${channelId}/mention_group` }),
        deleteChannelMentionGroup: this.buildEndpoint({
            method: "DELETE",
            urlPathBuilder: ({ channelId, mentionGroupId }) => `/chat/channels/${channelId}/mention_group/${mentionGroupId}`
        }),
        updateChannelMentionGroupInformation: this.buildEndpoint({
            method: "PATCH",
            urlPathBuilder: ({ channelId, mentionGroupId }) => `/chat/channels/${channelId}/mention_group/${mentionGroupId}`
        }),
        listMembersOfMentionGroup: this.buildEndpoint({
            method: "GET",
            urlPathBuilder: ({ channelId, mentionGroupId }) => `/chat/channels/${channelId}/mention_group/${mentionGroupId}/members`
        }),
        addChannelMembersToMentionGroup: this.buildEndpoint({
            method: "POST",
            urlPathBuilder: ({ channelId, mentionGroupId }) => `/chat/channels/${channelId}/mention_group/${mentionGroupId}/members`
        }),
        removeChannelMentionGroupMembers: this.buildEndpoint({
            method: "DELETE",
            urlPathBuilder: ({ channelId, mentionGroupId }) => `/chat/channels/${channelId}/mention_group/${mentionGroupId}/members`
        })
    };
    chatChannels = {
        listChannelActivityLogs: this.buildEndpoint({ method: "GET", urlPathBuilder: () => `/chat/activities/channels` }),
    ...
    chatChannelsAccountLevel = {
        ...
        listChannelActivityLogs: this.buildEndpoint({ method: "GET", urlPathBuilder: ({ channelId }) => `/chat/channels/${channelId}/activities` }),
        ...
        batchRemoveMembersFromUsersChannel: this.buildEndpoint({
            method: "DELETE",
            urlPathBuilder: ({ channelId, userId }) => `/chat/users/${userId}/channels/${channelId}/members`
        }),
        removeMember: this.buildEndpoint({
    ...
    chatMessages = {
        ...
        getForwardedMessage: this.buildEndpoint({ method: "GET", urlPathBuilder: ({ forwardId }) => `/chat/forwarded_message/${forwardId}` }),
    ...
    chatMigration = {
        ...
        getMigratedZoomChannelIDs: this.buildEndpoint({ method: "GET", urlPathBuilder: () => `/chat/migration/mappings/channels` }),
        getMigratedZoomUserIDs: this.buildEndpoint({ method: "GET", urlPathBuilder: () => `/chat/migration/mappings/users` }),
    ...
    invitations = {
        sendNewContactInvitation: this.buildEndpoint({ method: "POST", urlPathBuilder: ({ userId }) => `/chat/users/${userId}/invitations` })
    };
    legalHold = {
    ...
    reports = {
        ...
        getChatMessageReports: this.buildEndpoint({ method: "GET", urlPathBuilder: ({ sessionId }) => `/report/chat/sessions/${sessionId}` })
    };
    sharedSpaces = {
