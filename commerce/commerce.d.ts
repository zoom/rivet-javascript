...
type CommerceOAuthOptions<R extends Receiver> = CommonClientOptions<OAuth, R>;
declare class CommerceOAuthClient<ReceiverType extends Receiver = HttpReceiver, OptionsType extends CommonClientOptions<OAuth, ReceiverType> = CommerceOAuthOptions<ReceiverType>> extends ProductClient<OAuth, CommerceEndpoints, never, OptionsType, ReceiverType> {
