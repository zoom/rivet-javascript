...
class UsersEndpoints extends WebEndpoints {
    ...
    groups = {
        ...
        addGroupAdmins: this.buildEndpoint({
            method: "POST",
            urlPathBuilder: ({ groupId }) => `/groups/${groupId}/admins`
        }),
        ...
        addGroupMembers: this.buildEndpoint({
            method: "POST",
    ...
    users = {
        ...
        bulkUpdateFeaturesForUser: this.buildEndpoint({ method: "POST", urlPathBuilder: () => `/users/features` }),
...
exports.UsersEventProcessor = UsersEventProcessor;
exports.UsersOAuthClient = UsersOAuthClient;
exports.UsersS2SAuthClient = UsersS2SAuthClient;
