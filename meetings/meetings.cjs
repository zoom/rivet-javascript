...
class MeetingsEndpoints extends WebEndpoints {
    ...
    cloudRecording = {
        ...
        getMeetingTranscript: this.buildEndpoint({ method: "GET", urlPathBuilder: ({ meetingId }) => `/meetings/${meetingId}/transcript` }),
        deleteMeetingOrWebinarTranscript: this.buildEndpoint({ method: "DELETE", urlPathBuilder: ({ meetingId }) => `/meetings/${meetingId}/transcript` }),
    ...
    devices = {
        ...
        getZoomPhoneApplianceSettingsByUserID: this.buildEndpoint({ method: "GET", urlPathBuilder: () => `/devices/zpa/settings` }),
        upgradeZPAFirmwareOrApp: this.buildEndpoint({
            method: "POST",
        ...
        assignDeviceToGroup: this.buildEndpoint({ method: "PATCH", urlPathBuilder: ({ deviceId }) => `/devices/${deviceId}/assign_group` }),
    ...
    meetings = {
        ...
        updateParticipantRealTimeMediaStreamsRTMSAppStatus: this.buildEndpoint({ method: "PATCH", urlPathBuilder: ({ meetingId }) => `/live_meetings/${meetingId}/rtms_app/status` }),
        listAccountsMeetingOrWebinarSummaries: this.buildEndpoint({ method: "GET", urlPathBuilder: () => `/meetings/meeting_summaries` }),
    ...
    reports = {
        ...
        getHistoryMeetingAndWebinarList: this.buildEndpoint({ method: "GET", urlPathBuilder: () => `/report/history_meetings` }),
    ...
    sIPPhone = {
        listSIPPhones: this.buildEndpoint({ method: "GET", urlPathBuilder: () => `/sip_phones/phones` }),
        enableSIPPhone: this.buildEndpoint({ method: "POST", urlPathBuilder: () => `/sip_phones/phones` }),
        deleteSIPPhone: this.buildEndpoint({
            method: "DELETE",
            urlPathBuilder: ({ phoneId }) => `/sip_phones/phones/${phoneId}`
        }),
