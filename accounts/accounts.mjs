...
class AccountsEndpoints extends WebEndpoints {
    ...
    surveyManagement = {
        getSurveys: this.buildEndpoint({ method: "GET", urlPathBuilder: () => `/surveys` }),
        getSurveyInfo: this.buildEndpoint({ method: "GET", urlPathBuilder: ({ surveyId }) => `/surveys/${surveyId}` }),
        getSurveyAnswers: this.buildEndpoint({ method: "GET", urlPathBuilder: ({ surveyId }) => `/surveys/${surveyId}/answers` }),
        getSurveyInstances: this.buildEndpoint({ method: "GET", urlPathBuilder: ({ surveyId }) => `/surveys/${surveyId}/instances` })
    };
}
